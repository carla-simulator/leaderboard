...
class LeaderboardPerformanceEvaluator(LeaderboardEvaluator):

    def __init__(self, args, statistics_manager):
        super(LeaderboardPerformanceEvaluator, self).__init__(args, statistics_manager)
    ...
    def _register_statistics(self, config, checkpoint, entry_status, crash_message=""):
        super(LeaderboardPerformanceEvaluator, self)._register_statistics(
...
def main():
    ...
    try:
        leaderboard_evaluator = LeaderboardPerformanceEvaluator(arguments, statistics_manager)
