...
from ros_compatibility import CompatibleNode, latch_on, ros_ok, QoSProfile, ros_init, ros_timestamp, ROSException
...
class RosAgent(AutonomousAgent):
    ...
    def __init__(self, path_to_conf_file):
        ...
        self.ros_node = CompatibleNode("Leaderboard") 
        
        self.waypoint_publisher = self.ros_node.new_publisher(Path, "/carla/hero/waypoints", qos_profile=QoSProfile(depth=1, durability=latch_on))
